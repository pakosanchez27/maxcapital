...
>
  <head>
    ...
    <title>Max Capital - @yield('titulo')</title>
    ...
    <!-- Bootstrap 5 & DataTables Bootstrap 5 CSS -->
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Catálogos</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('credit-type.index') }}" class="menu-link">
                    <div data-i18n="Without menu">Tipos de Credito</div>
                  </a>
                </li>
                <li class="menu-item">
